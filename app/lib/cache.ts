...
const CACHE_FILE = path.resolve(process.cwd(), 'app/lib/cache-data.ts');
...
export const cacheData = ${JSON.stringify(data, null, 2)};
export default cacheData;
`;
    await fs.writeFile(CACHE_FILE, tsContent, 'utf-8');
}
