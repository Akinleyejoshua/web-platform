...
export async function POST(request: NextRequest) {
    try {
        ...
        if (type === 'cover-letter') {
            systemInstruction = `You are a professional cover letter writer. Generate a compelling cover letter based on the provided information. The response MUST be a JSON object with this exact structure: { "greeting": "Dear Hiring Manager,", "introduction": "2-3 sentence opening introducing the candidate and role interest", "body": ["Paragraph 1 with specific achievements", "Paragraph 2 with relevant skills", "Paragraph 3 with company alignment"], "conclusion": "2-3 sentence closing with call to action" }. Rules: greeting should be professional, introduction 2-3 sentences, body array of 3-4 paragraphs each 3-5 sentences, conclusion 2-3 sentences. Do NOT include candidate name or signature. Return ONLY valid JSON.`;
