...
My problem-solving abilities and adaptability make me a valuable asset in the ever-evolving landscape of software development.`,
    socialLinks: [
        ...
        { platform: 'linkedin', url: 'https://matching.turing.com/developer-resume-preview/94fcd098ef28063a611a36b6c211b83394302204b3221e', icon: 'linkedin' },
        { platform: 'website', url: 'https://j-resume.netlify.app', icon: 'globe' },
    ],
};
...
const projectsData = [
    ...
    },
    {
        ...
        category: 'web',
        mediaType: 'image',
        mediaUrl: 'https://akinleyejoshua.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fscreenshare.0136df29.png&w=3840&q=75',
